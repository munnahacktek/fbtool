...
def baliho():
	try:
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('FBTOOL').center(44)
		print (W + '     [' + R +'MODIFY by MUNNA '+ W + ']')
		print (W + '     [' + G +'HACKTEK FBHACKTOOL'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
* if you find any errors or problems , sovel by your selp
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'hacktek@' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'hacktek@' + W +'/' + R +'Bot ' + W + '>> ')
